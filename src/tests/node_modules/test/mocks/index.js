...
var remarkHtml = require('./remarkHtml');
...
},
{
  name: 'interface',
  mocks: [{
    pattern: 'application/actions/interface',
...
},
{
  name: 'settings',
  mocks:[{
    pattern: 'application/actions/settings',
    module: {
      'default': actionInterface.mockAction
    }
  }]
},
{
